                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form
                                action="{{ isset($transaksi) ? route('transaksi.tambahUser.updateUser', $transaksi->id) : route('transaksi.tambahUser.simpanUser') }}"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_user" id="id_user" class="custom-select">
                                                        <option value="" selected disabled hidden>-- Pilih User--
                                                        </option>
                                                        @foreach ($user as $row)
                                                            <option value="{{ $row->id }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_jenis_cucian" id="id_jenis_cucian"
                                                        class="custom-select">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_tipe_laundry" id="id_tipe_laundry"
                                                        class="custom-select">
                                                        <option value="" selected disabled hidden>-- Pilih Tipe
                                                            Laundry --</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_jenis_pencuci" id="id_jenis_pencuci"
                                                        class="custom-select">
                                                        <option value="" selected disabled hidden>-- Pilih Jenis
                                                            Pencuci --</option>
