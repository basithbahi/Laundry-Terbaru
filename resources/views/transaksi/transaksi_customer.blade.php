...
<body class="bg-gradient-primary">
    ...
    <form action="{{ isset($transaksi) ? route('transaksi.tambahUser.updateUser', $transaksi->id) : route('transaksi.tambahUser.simpanUser') }}"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="id_transaksi" name="id_transaksi"
                                value="{{ isset($transaksi) ? $transaksi->id_transaksi : '' }}" readonly>
                        </div>
                        <div class="form-group">
